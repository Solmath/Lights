...
void ChangeNeoPixels(uint16_t newCount)
{
  ...
  NeoPixelBus<NeoGrbFeature, NeoEsp8266Uart1Ws2812xMethod> strip(newCount);
...
void setup() {
  ...
  server.on("/", []() {
    ...
    String htmlContent =  "<!DOCTYPE html>"
                          ...
                          "<!--<button type=\"submit\" name=\"reboot\" class=\"waves-effect waves-light btn grey lighten-1\">Reboot</button>-->"
                          "</div>"
                          "</div>"
                          "</form>"
                          "</div>"
