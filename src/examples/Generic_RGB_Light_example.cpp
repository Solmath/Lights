...
void convert_xy()
{
  ...
  light.colors[0] = (int) (r * optimal_bri);
  light.colors[1] = (int) (g * optimal_bri);
  light.colors[2] = (int) (b * optimal_bri);
}
...
void convert_ct() {
  ...
  light.colors[0] = r * (optimal_bri / 255.0f);
  light.colors[1] = g * (optimal_bri / 255.0f);
  light.colors[2] = b * (optimal_bri / 255.0f);
}
...
void setup() {
  ...
  server.on("/state", HTTP_PUT, []() {
    ...
    if (error) {
      ...
      if (root.containsKey("alert") && root["alert"] == "select") {
        if (light.lightState) {
          light.currentColors[0] = 0; light.currentColors[1] = 0; light.currentColors[2] = 0;
        } else {
          light.currentColors[2] = 254;
        }
      }
      String output;
  ...
  server.on("/", []() {
    ...
    const char * htmlContent = "<!DOCTYPE html>"
                               ...
                               "</head>"
                               "<body>"
                               "<nav class=\"nav-extended row deep-purple\">"
                               ...
                               "<li class=\"tab\"><a href=\"#test2\">Preferences</a></li>"
                               "<li class=\"tab\"><a href=\"#test3\">Network settings</a></li>"
                               "</ul>"
                               "</div>"
                               "</nav>"
                               ...
                               "<label> Off <input type=\"checkbox\" name=\"pow\" id=\"pow\" value=\"1\"> <span class=\"lever\"></span> On </label>"
                               "</div>"
                               "</div>"
                               "</div>"
                               "<div class=\"row\">"
                               ...
                               "<div>"
                               "<canvas id=\"hue\" width=\"320px\" height=\"320px\" style=\"border:1px solid #d3d3d3;\"></canvas>"
                               "</div>"
                               "</div>"
                               "</div>"
                               "<div class=\"row\">"
                               ...
                               "<div class=\"row\">"
                               "<div class=\"col s4 m3\">"
                               "<label for=\"red\" class=\"col-form-label\">Red Pin</label>"
                               "<input type=\"number\" id=\"red\" name=\"red\">"
                               "</div>"
                               "<div class=\"col s4 m3\">"
                               "<label for=\"green\" class=\"form-label\">Green Pin</label>"
                               "<input type=\"number\" id=\"green\" name=\"green\">"
                               "</div>"
                               "<div class=\"col s4 m3\">"
                               "<label for=\"blue\" class=\"form-label\">Blue Pin</label>"
                               ...
                               "<input type=\"number\" id=\"rpct\" class=\"js-range-slider\" data-skin=\"round\" name=\"rpct\" value=\"\"/>"
                               "</div>"
                               "<div class=\"col s4 m3\">"
                               "<label for=\"gpct\" class=\"form-label\">Green multiplier</label>"
                               "<input type=\"number\" id=\"gpct\" class=\"js-range-slider\" data-skin=\"round\" name=\"gpct\" value=\"\"/>"
                               "</div>"
                               "<div class=\"col s4 m3\">"
                               "<label for=\"bpct\" class=\"form-label\">Blue multiplier</label>"
                               "<input type=\"number\" id=\"bpct\" class=\"js-range-slider\" data-skin=\"round\" name=\"bpct\" value=\"\"/>"
                               "</div>"
                               "</div>"
                               "<div class=\"row\">"
                               ...
                               "<label> Disable <input type=\"checkbox\" name=\"hwswitch\" id=\"hwswitch\" value=\"1\"> <span class=\"lever\"></span> Enable </label>"
                               "</div>"
                               "</div>"
                               "</div>"
                               ...
                               "<div class=\"switch section\">"
                               "<label> Disable <input type=\"checkbox\" name=\"disdhcp\" id=\"disdhcp\" value=\"0\"> <span class=\"lever\"></span> Enable </label>"
                               "</div>"
                               "</div>"
                               "</div>"
                               "<div class=\"switchable\">"
